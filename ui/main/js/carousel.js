...
// 制前品质异常项目滚动
function startExceptionCarousel() {
  const carousel = document.querySelector('.exception-carousel');
  const totalItems = document.querySelectorAll('.exception-carousel li').length;
  const itemHeight = document.querySelector('.exception-carousel li').clientHeight;
